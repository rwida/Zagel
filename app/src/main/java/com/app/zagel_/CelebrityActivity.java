...
public class CelebrityActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objDB = new MyDB(this,"celebrity");
        objmodelarrayList = new ArrayList<>();

        recyclerView = findViewById(R.id.recyclerview);

        mMediaPlayer = new MediaPlayer();
        mMediaPlayer = MediaPlayer.create(this , R.raw.celebrity);
        mMediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
        mMediaPlayer.setLooping(true);
        onPause();
        CountDownTimer cntr_aCounter = new CountDownTimer(45000, 1000) {
            @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(CelebrityActivity.this,MainActivity.class));
            finish();

        } else if (id == R.id.nav_policy){
            startActivity(new Intent(CelebrityActivity.this,PolicyActivity.class));
            finish();
        }

        else if (id == R.id.nav_football){
            startActivity(new Intent(CelebrityActivity.this,FootballActivity.class));
            finish();
        }

        else if (id == R.id.nav_economy){
            startActivity(new Intent(CelebrityActivity.this,EconomieActivity.class));
            finish();
        }

        else if (id == R.id.nav_celebrities){
            startActivity(new Intent(CelebrityActivity.this,CelebrityActivity.class));
            finish();
        }
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(CelebrityActivity.this);
    ...
    public void showData(){
        try {
            ...
            dbAdapter objDbadapter = new dbAdapter(objmodelarrayList,CelebrityActivity.this);
