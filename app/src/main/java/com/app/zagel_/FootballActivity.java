...
import com.app.zagel_.DBmodel;
import com.app.zagel_.MyDB;
import com.app.zagel_.R;
...
public class FootballActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onPause();
        CountDownTimer cntr_aCounter = new CountDownTimer(35000, 1000) {
            @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(FootballActivity.this,MainActivity.class));
            finish();

        } else if (id == R.id.nav_policy){
            startActivity(new Intent(FootballActivity.this,PolicyActivity.class));
            finish();
        }
            ...
            startActivity(new Intent(FootballActivity.this,EconomieActivity.class));
            finish();
        }

        else if (id == R.id.nav_celebrities){
            startActivity(new Intent(FootballActivity.this,CelebrityActivity.class));
            finish();
        }
    ...
    public void showData(){
        try {
            ...
            dbAdapter objDbadapter = new dbAdapter(objmodelarrayList,FootballActivity.this);
