...
public class EconomieActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objDB = new MyDB(this,"economie");
        objmodelarrayList = new ArrayList<>();

        recyclerView = findViewById(R.id.recyclerview);

        mMediaPlayer = new MediaPlayer();
        mMediaPlayer = MediaPlayer.create(this , R.raw.economie);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(EconomieActivity.this,MainActivity.class));
            finish();

        } else if (id == R.id.nav_policy){
            startActivity(new Intent(EconomieActivity.this,PolicyActivity.class));
            finish();
        }

        else if (id == R.id.nav_football){
            startActivity(new Intent(EconomieActivity.this,FootballActivity.class));
            finish();
        }

        else if (id == R.id.nav_economy){
            startActivity(new Intent(EconomieActivity.this,EconomieActivity.class));
            finish();
        }

        else if (id == R.id.nav_celebrities){
            startActivity(new Intent(EconomieActivity.this,CelebrityActivity.class));
            finish();
        }
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(EconomieActivity.this);
    ...
    public void showData(){
        try {
            ...
            dbAdapter objDbadapter = new dbAdapter(objmodelarrayList,EconomieActivity.this);
